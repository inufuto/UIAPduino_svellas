...
{
    static const uint8_t notes[] = {
        N4,C5, N4,C5, N4,G4, N4,G4, N8L,E5, N8R,D5, N8L,E5, N8R+N4,D5,
        N4,D5, N2P,C5, N4,0,
        0
    };
    WaitMelody(1, notes);
...
{
    static const uint8_t notes[] = {
        N4,C4, N4,E4, N4+N8L,G4, N4,A4,
        N8R,A4, N8L,G4, N8R,F4, N8L,G4, N8R,G4, N8L,A4, N8R,B4,
        N2P,C5, N4,0,
        0
    };
    WaitMelody(1, notes);
...
{
    static const uint8_t notes[] = {
        N8L,C5, N8R,C5, N8L,B4, N8R,B4, N8L,A4, N8R,A4, N8L,G4, N8R,E4,
        N8L,G4, N8R,G4, N8L,A4, N8R,B4, N2,C5,
        0
    };
    WaitMelody(1, notes);
}
...
void StartBGM()
{
    static const uint8_t notes1[] = {
        N4,C5, N4,C5, N4,G4, N4,G4, N8L,E5, N8R,D5, N8L,E5, N2,D5, N8R,0, // 3-5
        N4,E5, N4,G5, N8L,D5, N8R,C5, N8L,D5, N1,E5, N8R,0, // 5-6
        N4,F5, N4,F5, N4,E5, N4,E5, N8L,D5, N8R,D5, N8L,D5, N2,E5, N8R,0, // 7-8
        N4,F5, N4,F5, N4,E5, N4,E5, N8L,G5, N8R,G5, N8L,G5, N2,D5, N8R,0, // 9-10
        
        N4,C5, N4,C5, N4,G4, N4,G4, N8L,E5, N8R,D5, N8L,E5, N2,D5, N8R,0, // 11-12
        N4,E5, N4,G5, N8L,D5, N8R,C5, N8L,D5, N1,E5, N8R,0, // 13-14
        N4,F5, N4,F5, N4,E5, N4,E5, N8L,G5, N8R,G5, N8L,G5, N8R+N4,E5, N4,D5, // 15-16
        N4,C5, N4,G4, N8L,C5, N4,D5, N1,C5, N8R,0, // 17-18
        0xff
    };
    static const uint8_t notes2[] = {
        N8L,C3, N8R,0, N8L,C3, N8R,0, N4,C3, N8L,0, N8R,C3, // 19
        N8L,0, N8R,C3, N8L,0, N8R,C3, N8L,C3, N8R,D3, N8L,C3, N8R,D3S, // 20
        N8L,E3, N8R,B2, N8L,E3, N8R,0, N4,E3, N8L,0, N4,A2, // 21-
        N8R,A2, N8L,0, N8R,A2, N8L,A2, N8R,0, N8L,A2, N8R,0, // 22
        N8L,F3, N8R,C3, N8L,F3, N8R,0, N4,F3, N8L,0, N4,D3, // 23-
        N8R,D3, N8L,0, N8R,D3, N8L,D3, N8R,0, N8L,D3, N8R,0, // 24
        N8L,F2, N8R,0, N8L,F2, N8R,0, N4,F2, N8L,0, N4,G3, // 25-
        N8R,G3, N8L,0, N8R,D3, N8L,G3, N8R,D3, N8L,G3, N8R,0, // 26
        N8L,C3, N8R,0, N8L,C3, N8R,0, N4,C3, N8L,0, N8R,C3, // 27
        N8L,0, N8R,C3, N8L,0, N8R,C3, N8L,C3, N8R,D3, N8L,C3, N8R,D3S, // 28
        N8L,E3, N8R,B2, N8L,E3, N8R,0, N4,E3, N8L,0, N4,A2, // 29-
        N8R,A2, N8L,0, N8R,E2, N8L,A2, N8R,E2, N8L,A2, N8R,0, // 30
        N8L,F2, N8R,0, N8L,F2, N8R,0, N4,F2, N8L,0, N4,E2, // 31-
        N8R,E2, N8L,0, N8R,E2, N8L,E2, N8R,0, N8L,E2, N8R,0, // 32
        N8L,C3, N8R,0, N8L,C3, N8R,0, N4,G2, N8L,0, N4,C3, //33-
        N8R,C3, N8L,0, N8R,C3, N8L,C3, N8R,0, N8L,C3, N8R,0, // 34
        0xff
    };
    Enabled = false;
